validTab=[0,0,0,0,0]; //0-nieprawidÅ‚owe, 1-prawidÅ‚owe
function dodatek(){
    var dodatek = document.getElementById('dodatek').value;
    var pattern = /^[A-Za-zÄ…Ä™Ã³Å‚Å›Ä‡Å¼Åº]{3,40}$/;
...
function ulica(){
    ...
    var pattern = /^[A-Z][a-zÄ…Ä™Ã³Å‚Å›Ä‡Å¼Åº]{2,30}$/;
...
function zamow(){
    document.getElementById('status').innerHTML="ZamÃ³wienie zostaÅ‚o przyjÄ™te do realizacji";
